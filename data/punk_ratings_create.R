...
# create a data frame fromt the html table
beer_ratings <- html_nodes(html, xpath = xpath) %>% 
...
# remove the 'BrewDog' from Name to get the beer name and type
...
# add beername and type to data, remove the 'Name' column and rename the columns
